...
/*ENTRGDR*/ (SELECT ID FROM FUNCIONARIO WHERE NOME LIKE '%'||V_ENTREGADOR||'%')
      ...
      SELECT ATUALIZA_CAIXA((SELECT PRECO FROM PRODUTO WHERE NOME LIKE '%'||V_PRODUTO||'%') + (SELECT VALOR FROM FRETE WHERE DISTANCIA = V_FRETE ));
      SELECT INSERT_VENDA_FUNCIONARIO(V_FUNCIONARIO, (SELECT PRECO FROM PRODUTO WHERE NOME LIKE '%'||V_PRODUTO||'%' ));
